...
def beta_create_BfCtaService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  ...
  request_deserializers = {
    ('bfcta.BfCtaService', 'ConnectPush'): bfgateway_pb2.BfConnectPushReq.FromString,
    ('bfcta.BfCtaService', 'DisconnectPush'): bfgateway_pb2.BfVoid.FromString,
    ('bfcta.BfCtaService', 'Ping'): bfgateway_pb2.BfPingData.FromString,
    ('bfcta.BfCtaService', 'Start'): bfgateway_pb2.BfVoid.FromString,
    ('bfcta.BfCtaService', 'Stop'): bfgateway_pb2.BfVoid.FromString,
  }
  response_serializers = {
    ('bfcta.BfCtaService', 'ConnectPush'): google.protobuf.any_pb2.Any.SerializeToString,
    ('bfcta.BfCtaService', 'DisconnectPush'): bfgateway_pb2.BfVoid.SerializeToString,
    ('bfcta.BfCtaService', 'Ping'): bfgateway_pb2.BfPingData.SerializeToString,
    ('bfcta.BfCtaService', 'Start'): bfgateway_pb2.BfVoid.SerializeToString,
    ('bfcta.BfCtaService', 'Stop'): bfgateway_pb2.BfVoid.SerializeToString,
  }
...
def beta_create_BfCtaService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  ...
  import bfgateway_pb2
  request_serializers = {
    ('bfcta.BfCtaService', 'ConnectPush'): bfgateway_pb2.BfConnectPushReq.SerializeToString,
    ('bfcta.BfCtaService', 'DisconnectPush'): bfgateway_pb2.BfVoid.SerializeToString,
    ('bfcta.BfCtaService', 'Ping'): bfgateway_pb2.BfPingData.SerializeToString,
    ('bfcta.BfCtaService', 'Start'): bfgateway_pb2.BfVoid.SerializeToString,
    ('bfcta.BfCtaService', 'Stop'): bfgateway_pb2.BfVoid.SerializeToString,
  ...
  response_deserializers = {
    ('bfcta.BfCtaService', 'ConnectPush'): google.protobuf.any_pb2.Any.FromString,
    ('bfcta.BfCtaService', 'DisconnectPush'): bfgateway_pb2.BfVoid.FromString,
    ('bfcta.BfCtaService', 'Ping'): bfgateway_pb2.BfPingData.FromString,
    ('bfcta.BfCtaService', 'Start'): bfgateway_pb2.BfVoid.FromString,
    ('bfcta.BfCtaService', 'Stop'): bfgateway_pb2.BfVoid.FromString,
